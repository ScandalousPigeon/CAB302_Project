...
public class AiSafetyGuardrail {
    ...
    public static final String SAFETY_INSTRUCTIONS = """
            ...
            - Do not complete homework, exams, or assessments for the user. Offer hints, explanations, debugging guidance, or learning steps instead.
    ...
    public GuardrailDecision assessUserMessage(String message) {
        ...
        if (asksForAcademicShortcut(normalized)) {
            return GuardrailDecision.blocked(
                    "Academic shortcut request",
                    learningSupportMessage(normalized)
            );
        }
